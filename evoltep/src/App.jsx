...
const WhatsAppBtn = () => (
  <motion.a
    ...
    whileTap={{ scale: 0.95 }}
    className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow duration-300"
    ...
    <AnimatePresence>
      {show && (
        <motion.button
          ...
          className="fixed bottom-24 right-6 z-40 w-10 h-10 bg-brand-blue text-white rounded-full flex items-center justify-center shadow-glow hover:shadow-glow-lg transition-shadow"
